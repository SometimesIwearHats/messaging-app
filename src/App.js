...
// Firebase config (normally this would be in a separate file being ignored by Git to hide API key)
...
// Sign in function with Google accounts
function SignIn() {
